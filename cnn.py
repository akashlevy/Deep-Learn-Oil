...
model.add_conv_pool_layer(filters=24, filter_length=11, poolsize=2, activ_fn=relu)
model.add_conv_pool_layer(filters=24, filter_length=12, poolsize=2, activ_fn=relu)

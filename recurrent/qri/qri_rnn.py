...
def test_softmax(dataset, n_epochs=250):
    ...
    model.fit(seq, targets, validation_frequency=250)
    ...
    # true_targets = plt.step(xrange(n_steps), targets[0], marker='o')

    # # show probabilities (in b/w) output by model
    # guess = model.predict_proba(seq[0])
    ...
    for seq_num in seqs:
        ...
        print "".join([chr(n) for n in guess]),

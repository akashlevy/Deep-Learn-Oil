...
class MetaRNN(BaseEstimator):
    ...
    # Load the dataset: "mnist.pkl.gz"
    def load_data(self, dataset):
        logger.info("Loading from %s ..." % dataset)
    ...
    def fit(self, test_set, valid_set, train_set, X_test=None, Y_test=None,
        ...
        if test_set is not None:
            assert(valid_set is not None and train_set is not None)
...
def test_real():
    ...
    data = model.load_data("mnist.pkl.gz")
    model.fit(data[0], data[1], data[2], validation_frequency=1000)

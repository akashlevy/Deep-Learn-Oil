...
import cPickle
import gzip
#this importing of matplotlib is needed to run on the cluster
#due to issues with displaying imagers
import matplotlib
...
#implementation of rectified linear units that I could not get to work
def relu(x):
...
class RBM(object):
    ...
    def reconstruct(self, v):
    	...
    	"""
    #reconstruction function taken from https://github.com/yusugomori/DeepLearning/tree/master/python  
    def reconstruct(self, v):
...
def test_rbm(learning_rate=0.01, training_epochs=20,
    ...
    #test_set_x is used as input; real_set_x is used as "right" input 
    ...
    arrayZ.fill(.5)
    #concatenate all but last 12 values to numpy array consisting of .5 (since only 0 to 1 can be used as outputs)
    ...
    #this section of code is used to determine whether reconstructions of single rows 
    #worked properly
    """ 
    ...
    """
    #print statements for reconstruction of single rows
    ...
    #first instance of reconstruction of entire test set    
    reconstruction = rbm.reconstruct(test_set_x).eval()

    print "plotting predictions"
    #this takes the mean of 100 reconstructions
    for i in xrange(len(reconstruction)-1):
        ...
        guess = sum / 100
	#first value is first 36 values of real_set_x; second value is last 12 values of real_set_x; last is the full reconstruction
    ...
    #this section of code was used to plot reconstruction of single rows
    """
    for i in xrange(len(reconstruction)-1):
...
def plot_predictions(i, curr_seq, curr_y, curr_guess, display_figs=True, save_figs=True,
    ...
    #this section, again, plots reconstructions of single rows
